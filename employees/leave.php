...
<body>
    ...
    <div class="page-container">
        ...
        <div class="sidebar-menu">
            <div class="sidebar-header">
                <div class="logo">
                    <a href="leave.php"><img src="../assets/images/icon/Logo-Final.png" alt="logo"></a>
                </div>
            </div>
            <div class="main-menu">
    ...
    <!--The Bot API is used here  -->
<script src="https://cdn.botpress.cloud/webchat/v1/inject.js"></script>
<script src="https://mediafiles.botpress.cloud/8b39ab3c-2f6b-44a7-b963-2326222948dd/webchat/config.js" defer></script>
